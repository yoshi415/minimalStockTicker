  ...
  if (toAdd) {
    (0, _fetch2.default)(toAdd).then(function (quote) {
      if (quote[0][1] !== 'N/A') {
        ...
        var stock = [symbol].concat(_toConsumableArray(quote));
        textField.value = '';
