...
function addSymbol() {
  ...
  if (toAdd) {
    (0, _fetch2.default)(toAdd).then(function (data) {
      if (data) {
        var stock = data[0].resource.fields;
        var symbol = stock.symbol.toUpperCase();
