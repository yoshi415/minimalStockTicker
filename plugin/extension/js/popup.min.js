...
exports.displaySymbols = exports.addSymbol = undefined;

var _fetch = require('../../util/fetch');

var _fetch2 = _interopRequireDefault(_fetch);

var _update = require('../../util/update');
...
function addSymbol(symbols, disabled) {
  var textField = document.getElementById('symbolValue');
  var toAdd = [textField.value];

  if (toAdd) {
    (0, _fetch2.default)(toAdd).then(function (quote) {
      if (quote.length > 0) {
        var data = quote.split(',');
        if (data[0] === "N/A") {
          message.innerHTML = 'Symbol could not be looked up! Try again';
          return;
        }
        var symbol = textField.value.toUpperCase();
        var price = data[0];
        var percent = data[1].slice(1, data[1].length - 2);
        var stock = [symbol, price, percent];
        textField.value = '';

        if (symbolNotFound(symbols, symbol)) {
          symbols.push(stock);
          chrome.storage.sync.set({ symbols: symbols });
...
function displaySymbols(symbols) {
  var display = document.getElementById('displaySymbols');
  var list = [];
  var html = '';
...
>>>>>>> 1b2cb8a019189c0520757d913379a306506b792d
    });
    display.innerHTML = '';
...
function symbolNotFound(collection, target) {
  var found = true;
  collection.some(function (symbol) {
    if (symbol[0] === target) {
      found = false;
    }
  });
...
function removeSymbol(symbol) {
  chrome.storage.sync.get('symbols', function (storage) {
    var symbols = storage.symbols;
    var remove = void 0;
    symbols.forEach(function (stock, index) {
      if (stock[0] === symbol) {
        remove = index;
      }
    });
...
function attachHandlers(symbols) {
  ...
  symbols.forEach(function (symbol) {
    document.getElementById(symbol[0]).addEventListener('click', removeSymbol.bind(_this, symbol[0]));
  });
}

exports.addSymbol = addSymbol;
exports.displaySymbols = displaySymbols;

},{"../../util/fetch":300,"../../util/update":301}],299:[function(require,module,exports){
'use strict';
...
chrome.storage.sync.get(['symbols', 'blacklisted'], function (storage) {
  symbols = storage.symbols || [];
  blacklisted = storage.blacklisted || [];
  (0, _symbols.displaySymbols)(symbols);
  document.getElementById('symbolBtn').addEventListener('click', _symbols.addSymbol.bind(undefined, symbols));
});

chrome.runtime.connect();

function toggleColor() {
  chrome.storage.sync.get('toggleColor', function (storage) {
...
function blacklist() {
  chrome.tabs.query({ currentWindow: true, active: true }, function (tabs) {
    var hostname = getHostname(tabs);
    blacklisted.push(hostname);
    chrome.storage.sync.set({ blacklisted: blacklisted });
  });
...
function unblacklist() {
  chrome.storage.sync.get('blacklisted', function (storage) {
    chrome.tabs.query({ currentWindow: true, active: true }, function (tab) {
      blacklisted = storage.blacklisted;
      var index = blacklisted.indexOf(getHostname(tab));
...
function returnSubmit(e) {
  if (e && e.keyCode === 13) {
    e.preventDefault();
    (0, _symbols.addSymbol)(symbols);
  }
}

},{"./helpers/symbols":298}],300:[function(require,module,exports){
'use strict';
...
exports.default = function () {
  var _ref = _asyncToGenerator(regeneratorRuntime.mark(function _callee(symbols) {
    var symbol, url, response, data;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            symbol = symbols.length === 1 ? symbols[0] : symbols.join(',');
<<<<<<< HEAD
            url = 'https://download.finance.yahoo.com/d/quotes.csv?s=' + symbol + '&f=ap2d1t1';
=======
            url = 'http://download.finance.yahoo.com/d/quotes.csv?s=' + symbol + '&f=ap2';
>>>>>>> 1b2cb8a019189c0520757d913379a306506b792d
            _context.prev = 3;
            _context.next = 6;
            return fetch(url);
          ...
          case 13:
            ...
            console.log('Error fetching ' + symbol, _context.t0);
...
},{"babel-polyfill":1}],301:[function(require,module,exports){
'use strict';
...
exports.default = function () {
  chrome.storage.sync.get('symbols', function (storage) {
    var toUpdate = [];
    if (storage.symbols) {
      storage.symbols.forEach(function (stock) {
        return toUpdate.push(stock[0]);
      });
<<<<<<< HEAD
      (0, _fetch2.default)(toUpdate).then(function (symbols) {
        return chrome.storage.sync.set({ symbols: symbols });
=======
      console.log('update', toUpdate);
      (0, _fetch2.default)(toUpdate).then(function (stocks) {
        return chrome.storage.sync.set({ stocks: stocks });
>>>>>>> 1b2cb8a019189c0520757d913379a306506b792d
      });
