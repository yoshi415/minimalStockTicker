...
exports.default = function () {
  var ref = _asyncToGenerator(regeneratorRuntime.mark(function _callee(symbol) {
    var url, response, data;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            url = "https://finance.yahoo.com/webservice/v1/symbols/" + symbol + "/quote?format=json";
            _context.prev = 1;
            _context.next = 4;
            return fetch(url);
          ...
          case 7:
            data = _context.sent;
            return _context.abrupt("return", data.list.resources[0].resource.fields);
