...
function symbolNotFound(currentSymbols, newSymbol) {
  return !currentSymbols.some(function (symbol) {
    return symbol[0] === newSymbol;
  });
}

function removeSymbol(symbol) {
  chrome.storage.sync.get('symbols', function (_ref) {
...
function attachHandlers(symbols) {
  ...
  symbols.forEach(function (symbol) {
    var el = document.getElementById(symbol[0]);
    el.addEventListener('click', removeSymbol.bind(_this, symbol[0]));
  });
}
