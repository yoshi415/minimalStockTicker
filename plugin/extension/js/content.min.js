...
var _getQuotes = require('./helpers/getQuotes');

var _getQuotes2 = _interopRequireDefault(_getQuotes);
...
function update(newValues) {
  setInterval(_getQuotes2.default.bind(this, newValues), 10000);
}

},{"./helpers/getQuotes":192,"babel-polyfill":1}],192:[function(require,module,exports){
'use strict';
...
exports.default = function (symbols) {
  ...
  (0, _fetch2.default)(symbols).then(function (data) {
...
function appendHTML(html) {
  ...
  var del = document.getElementById('deleteStock');
