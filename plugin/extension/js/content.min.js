...
chrome.storage.sync.get('stocks', function (storage) {
  ...
  (0, _displayStocks2.default)(stocks);
  // createiFrame();
});

chrome.storage.onChanged.addListener(function (changed) {
  if (changed.stocks) {
    var updated = changed.stocks.newValue;
    (0, _displayStocks2.default)(updated);
  }
  if (changed.symbols) {
    var symbols = changed.symbols.newValue;
    (0, _update2.default)(changed.symbols.newValue);
  }
});

},{"../util/update":195,"./helpers/displayStocks":192,"./helpers/iframe":193,"babel-polyfill":1}],192:[function(require,module,exports){
'use strict';
