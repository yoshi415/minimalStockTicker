...
chrome.storage.onChanged.addListener(function (changed) {
  var update = changed.stocks.newValue;
  (0, _displayStocks2.default)(update);
});
...
},{"../util/update":194,"./helpers/displayStocks":192,"babel-polyfill":1}],192:[function(require,module,exports){
'use strict';
