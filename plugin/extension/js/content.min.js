...
var blacklisted = void 0,
    disabled = void 0;

chrome.storage.sync.get(['stocks', 'blacklisted', 'disabled'], function (storage) {
...
},{"./helpers/iframe":299,"babel-polyfill":1}],299:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.getiFrame = exports.removeiFrame = exports.createiFrame = undefined;

var _iframeStyles = require('./iframeStyles');
...
function createiFrame() {
  var exists = getiFrame();
  if (!exists) {
    var frame = document.createElement('iframe');
    frame.setAttribute('src', '' + chrome.extension.getURL('stockTicker.html'));
    frame.setAttribute('id', 'minimalStockTicker');
    setStyles(frame.style, _iframeStyles.iframeStyles);
    setStyles(document.body.style, _iframeStyles.bodyStyles);
...
},{"./iframeStyles":300}],300:[function(require,module,exports){
'use strict';
