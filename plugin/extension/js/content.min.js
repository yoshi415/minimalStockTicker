...
},{"../util/fetch":193,"./helpers/iframe":192,"babel-polyfill":1}],192:[function(require,module,exports){
'use strict';
...
exports.default = function (symbols) {
  var stocks = [];
  var html = '';
  for (var symbol in symbols) {
    stocks.push(symbols[symbol]);
  }
  (0, _fetch2.default)(stocks).then(function (data) {
    console.log(data);
...
},{"../../util/fetch":193}],193:[function(require,module,exports){
'use strict';
