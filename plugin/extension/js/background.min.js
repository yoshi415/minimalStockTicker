...
var blacklisted = ["google.com/maps", "docs.google.com", "mail.google.com", "facebook", "8tracks", "pivotaltracker.com/signin", "linkedin"];
...
function checkCurrTab(activeTab) {
  chrome.tabs.query({ active: true, currentWindow: true }, function (tab) {
    var hideMessage = checkList(tab[0]);
    if (hideMessage) {
      disable(tab[0].id);
    }
  });
...
},{"../util/update":193}],192:[function(require,module,exports){
'use strict';
