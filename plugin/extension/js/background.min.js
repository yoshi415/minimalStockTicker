...
var _disable = require('./helpers/disable');
...
chrome.tabs.onUpdated.addListener(function (tabId, info, tab) {
  (0, _disable.checkDisabledOnUpdated)(tab);
  (0, _disable.checkBlackListOnUpdated)(tab);
});
chrome.tabs.onActivated.addListener(function () {
  (0, _disable.checkDisabledOnActivated)();
  (0, _disable.checkBlackListOnActivated)();
});
...
},{"../util/update":301,"./helpers/disable":299}],299:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
var defaultDisabledSites = ["google.com/maps", "docs.google.com", "mail.google.com", "facebook", "8tracks", "pivotaltracker.com/signin", "linkedin"];

function checkDisabledOnUpdated(tab) {
  var disabled = checkDisabledList(tab);
...
function checkDisabledOnActivated() {
  chrome.tabs.query({ active: true, currentWindow: true }, function (tab) {
    var disabledPage = checkDisabledList(tab[0]);
    if (disabledPage) {
...
function checkDisabledList(tab) {
  var inList = false;
  defaultDisabledSites.forEach(function (text) {
...
function checkBlackListOnUpdated(tab) {
  chrome.storage.sync.get('blacklisted', function (storage) {
    if (storage.blacklisted) {
      storage.blacklisted.forEach(function (site) {
...
exports.checkDisabledOnUpdated = checkDisabledOnUpdated;
exports.checkDisabledOnActivated = checkDisabledOnActivated;
exports.checkBlackListOnUpdated = checkBlackListOnUpdated;
exports.checkBlackListOnActivated = checkBlackListOnActivated;
