...
chrome.storage.onChanged.addListener(function (changed) {
  ...
  if (changed.symbols) {
    (0, _update2.default)(changed.symbols.newValue, toggleColor);
  }
