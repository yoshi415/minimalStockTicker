...
exports.default = displayStocks;
function displayStocks() {
  var stocks = arguments.length <= 0 || arguments[0] === undefined ? [] : arguments[0];
  var toggleColor = arguments[1];

  var html = '';
  var last = stocks.length - 1;

  stocks.forEach(function (stock, index) {
    return html += createSpan(stock, index, last, toggleColor);
  });
  appendHTML(html);
}
...
function appendHTML(html) {
  ...
  var stockToRemove = document.getElementById('stockSpan');
...
},{"../util/update":194,"./helpers/displayStocks":191}],193:[function(require,module,exports){
'use strict';
