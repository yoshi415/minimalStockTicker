...
function createSpan(stock, index, last, toggleColor) {
  var symbol = '<a class="stockLink" target="_blank" href="http://finance.yahoo.com/q?s=' + stock[0] + '">' + stock[0] + '</a>';
  var price = Number(stock[1]).toFixed(2);
  var chg = removeQuotes(stock[2]);
  var time = removeQuotes(stock[4]);
  var date = removeQuotes(stock[3]);
  if (chg[0] === '-') {
    chg = '(' + chg.slice(1) + ')';
  }
...
exports.default = function () {
  var _ref = _asyncToGenerator(regeneratorRuntime.mark(function _callee(symbols) {
    var symbol, url, response, data, quotes;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 9:
            ...
            quotes.pop();
            return _context.abrupt('return', quotes.map(parseData(symbols)));
...
function parseData(symbols) {
  return function (data, index) {
    ...
    var _data$split2 = _slicedToArray(_data$split, 4);

    var price = _data$split2[0];
    var percent = _data$split2[1];
    var date = _data$split2[2];
    var time = _data$split2[3];
