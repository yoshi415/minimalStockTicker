...
exports.default = function (stocks) {
  var html = '';
...
function createSpan(stock, index, last) {
  var symbol = stock.resource.fields;
  var date = new Date(symbol.utctime);
  var day = date.getDate();
  var monthIndex = date.getMonth();
  var year = date.getFullYear();
  var blah = date.toString().replace(/\S+\s(\S+)\s(\d+)\s(\d+)\s.*/, '$2-$1-$3');
  // console.log(date, day, monthIndex, year, blah)
  var sym = '<a class="stockLink" target="_blank" href="http://finance.yahoo.com/q?s=' + symbol.symbol + '">' + symbol.symbol + '</a>';
  var price = Number(symbol.price).toFixed(2);
  var chg = Number(symbol.chg_percent).toFixed(2);

  var span = '<span class="stockFont"> ' + sym + ' ' + price + ' <span class="';
...
var _iframe = require('../content/helpers/iframe');

var _iframe2 = _interopRequireDefault(_iframe);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

chrome.storage.sync.get('stocks', function (storage) {
  (0, _displayStocks2.default)(storage.stocks);
});

chrome.storage.onChanged.addListener(function (changed) {
  if (changed.stocks) {
    (0, _displayStocks2.default)(changed.stocks.newValue);
  }
  if (changed.symbols) {
    (0, _iframe2.default)();
...
},{"../content/helpers/iframe":191,"../util/update":195,"./helpers/displayStocks":192}],194:[function(require,module,exports){
'use strict';
