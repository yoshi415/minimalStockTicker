...
exports.default = function (stocks, toggleColor, symbols) {
  var html = '';
  if (symbols) {
    (function () {
      var last = symbols.length - 1;
      symbols.forEach(function (symbol, index) {
        return html += createSpan(symbol, index, last, toggleColor);
      });
    })();
  }
...
function createSpan(symbol, index, last, toggleColor) {
  var _symbol = _slicedToArray(symbol, 5);

  var displaySymbol = _symbol[0];
  var price = _symbol[1];
  var change = _symbol[2];
  var date = _symbol[3];
  var time = _symbol[4];

  console.log('price', price);
  var chg = change.slice(1, change.length - 1);
  if (chg[0] === '-') {
    chg = '(' + chg.slice(1) + ')';
  }
  var link = '<a class="stockLink" target="_blank" href="http://finance.yahoo.com/q?s=' + displaySymbol + '">' + displaySymbol + '</a>';

  var span = '<span class="stockFont"> ' + link + ' ' + price + ' <span class="';
  if (!toggleColor) {
...
function appendHTML(html) {
  ...
  var del = document.getElementById('stockSpan');
...
var _displayStocks = require('./helpers/displayStocks');

var _displayStocks2 = _interopRequireDefault(_displayStocks);
...
var toggleColor = void 0;
var stocks = void 0;

chrome.storage.sync.get(['symbols', 'stocks', 'toggleColor'], function (storage) {
  ...
  (0, _displayStocks2.default)(stocks, toggleColor, symbols);
});
...
chrome.storage.onChanged.addListener(function (changed) {
  if (changed.stocks) {
    ...
    if (stocks.length !== 0) {
      (0, _displayStocks2.default)(stocks, toggleColor);
    }
    chrome.storage.sync.get(['symbols'], function (storage) {
      return (0, _displayStocks2.default)(stocks, toggleColor, symbols);
    });
  }
  if (changed.symbols) {
<<<<<<< HEAD
    var _symbols = changed.symbols.newValue;
    if (_symbols.length !== 0) {
      (0, _update2.default)(_symbols, toggleColor);
      (0, _displayStocks2.default)([], toggleColor, _symbols);
=======
    var symbols = changed.symbols.newValue;
    console.log('symbols', symbols);
    if (symbols.length !== 0) {
      (0, _update2.default)(symbols, toggleColor);
>>>>>>> 1b2cb8a019189c0520757d913379a306506b792d
    }
  }
  if (changed.toggleColor) {
    (0, _displayStocks2.default)(stocks, changed.toggleColor.newValue);
  }
});

},{"../util/update":301,"./helpers/displayStocks":298}],300:[function(require,module,exports){
'use strict';
